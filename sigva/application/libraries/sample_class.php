<?php 
	...
	class Sample_class{
		...
		//authorization
    private $clientId = 'd8b838a4ec0e45c6f2d700296add15cef374a9020e3d764f316413773a83d59c';
    private $secretKey = '59d6675d69ed6fa1238ec68ee8781c6be0e04d9849308f3ff7524c401bc58532';
    private $shortCode = '2929007247';
    ...
    public function sendText($messageID, $to, $message) {
        ...
        /* 
             dito ko na ilalay si logs para sa pag send ng message

             i can do it.. paul do it so iam i.
        */
    }
    ...
    public function reply($requestID, $messageID, $to, $cost, $message) {
        ...
        /* return true if the $cost is null*/
    ...
    public function receiveNotifications() {
        $fromChikka = $_POST; // the response POST array of chikka
        
        /* check if the keys expected chikka response, array() fromChikka*/
    ...
    private function sendApiRequest($data){
        ...
        /* merge the no_name_array to the $data array */
